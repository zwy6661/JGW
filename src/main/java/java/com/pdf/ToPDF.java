...
public class ToPDF {
	...
	public void test(String path1,String path2) {
		...
		try {
			...
			PDDocumentInformation info=pdd.getDocumentInformation();
			...
			for(int i=0;i<pageNum;i++) {
				...
				//FileOutputStream fos=new FileOutputStream("C:\\Users\\22682\\Desktop\\PDF\\"+path2+(i)+".txt");
					...
					if(images.getItem(obj.getName()) instanceof COSDictionary) {
						...
						while(its.hasNext()) {
							...
							if(resource.isImageXObject(cosName)) {
								...
								//FileOutputStream fos1=new FileOutputStream("C:\\Users\\22682\\Desktop\\PDF\\"+path2+"第"+(i+1)+"页_"+t+".jpg");
								...
								ImageIO.write(bi, stuf, new File("C:\\Users\\22682\\Desktop\\PDF\\"+path2+"第"+(i+1)+"页_"+t+".jpg"));
								t++;
							}
	...
	public static void main(String[]a) {
		...
		File file=new File("C:\\Users\\22682\\Desktop\\释_单育辰.pdf");
	...
	public static COSDictionary cosDict(COSDictionary cos,PDResources resource) throws IOException, InterruptedException {
		...
		out.println();
		out.println();
		System.err.println("����ݹ�     "+cos);
		err.println();
		System.err.println("����ݹ�    "+cos.getValues());
