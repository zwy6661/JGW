		...
		try {
			...
			for(FileItem item:fileitems) {
				...
				if(item.isFormField()) {
						...
						Find.select("D:\\testmaven\\test.jpg");
						...
						while(it.hasNext()) {
							...
							HTML=HTML+"<div style='float:left'>"
									...
									+ "<li class='title' style='text-algin:center;'>匹配率："+(int)(Float.parseFloat(score)*100)+"%</li>"+
									"<li class='bullet-item'>"
									+"<embed src='"+pdf+"' width=\"600\" height=\"400\">"
									+"</li></ul></div>";
							num++;
